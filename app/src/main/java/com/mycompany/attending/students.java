    ...
    String name[][] = {
            {
                    ...
                    "MERIN THERES JOSE",
                    "SIDDARTH VARMA MANTENA",
                    "C. SAI SUJIT",
                    "AGASTYA",
                    "TUSHAR KUMAR",
                    "KAUSTUBH PRAFULLA GOGE",
                    "ARUSHI WADDEPALLI",
                    "MAYANK KATNORIA",
                    "DIYA ANNA VARGHESE",
                    "RUSHIL DHINGRA",
                    ...
                    "KRISHNA GUPTA",
                    "SAOOD ALI",
                    "JANHAVI AJAY MADIWALE",
                    "KACHHADIYA MANANKUMAR RAJNISHBHAI",
            ...
            },
            {
                    ...
                    "SAMAY TORADMAL",
                    "AACHMAN YADAV",
                    "P SANTHOSH SRI SAI RAM",
                    "VAIDIK SAXENA",
                    "HARSHIT",
                    "KHUSHI",
                    "VIKAS GOTHAWAL",
                    "ADITYA CHANDAK",
                    "PEDAGAMALLA SAI SRINIDHI",
                    "SMARAK GARTIA",
                    "CHILLAMACHARLA ANISHA",
                    "MOHD ARHAM FAROOQUI",
                    "SHAIK MEER GHALIB SHAHEED",
                    "ARUSH SRIVASTAVA",
                    "NIDUBROLU LOCHIT VINAY",
                    "NISHCHAL CHANDEL",
                    "NAYAKAM RAKSHITH KUMAR",
                    "BOBBA VISHWANTH REDDY",
                    "CHARITHA TUBATI",
                    "ROHAN GARG",
                    "ANIKA JAIN",
                    "SATHVIKA AJMEERA",
            ...
            },
            {
                    ...
                    "ABHAS NATH",
                    "CHANDRASEKHAR",
                    "CHILKURI PRADYUMNA REDDY",
                    "SAI VIKAS SUTHAPALLI",
                    "ARHAM KACHHARA",
                    "SHREYANSH JAIN",
                    "ASHUTOSH SAUGAN",
                    "PAGADALA SINDHUJA",
                    ...
                    "SHIKHAR AGARWAL",
                    "ROHIT SINGH",
                    "PANMAND PRANAV SANTOSH",
                    "MANOJ KUMAR",
                    "SRUSHTI VISPUTE",
                    "MEHUL KUMAR DEWANGAN",
                    "SUHANI THAKUR",
                    "LAVANYA NAGAR",
                    "ANMOL AGRAWAL",
                    "GEORGE JOSEPH",
    ...
    public void done(View v) {
        ...
        if(branching<4){
           ...
           // abc=abc.substring(0,abc.length()-2);
            ...
            editor.putString("current", abc.substring(0,abc.length()-2));
            editor.apply();
        ...
        //new stats().toast("ABSENTEES MARKED");
        ...
        if(branching==4)
        {
            ...
            branching=0;
            Intent j=new Intent(this, student2.class);
            Toast.makeText(getApplicationContext(), "ABSENTEES MARKED", Toast.LENGTH_LONG).show();
            startActivity(j);
